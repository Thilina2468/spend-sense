...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-dark-card border-r border-dark-border flex flex-col hidden md:flex">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all-smooth ${
                active
                  ? 'bg-gradient-to-r from-neon-green/20 to-neon-cyan/10 text-neon-green border border-neon-green/50 shadow-neon-green'
